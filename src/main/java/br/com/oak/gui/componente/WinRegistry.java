...
//			readStringValues(HKEY_CURRENT_USER, "Software\\Microsoft\\Windows\\CurrentVersion\\Screensavers"); 

			System.out.println("==> " + readString(HKEY_LOCAL_MACHINE,"SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\{2D8ECA7B-C08C-4FA6-B9FE-30B76C03B8DC}_is1","InstallLocation"));
			
			System.out.println("==> " + readString(HKEY_LOCAL_MACHINE,"SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\{2D8ECA7B-C08C-4FA6-B9FE-30B76C03B8DC}_is1","DisplayVersion"));
			
			System.out.println("==> " + readString(HKEY_LOCAL_MACHINE,"SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\{2D8ECA7B-C08C-4FA6-B9FE-30B76C03B8DC}_is1","UninstallString"));
			
			System.out.println("==> " + readString(HKEY_LOCAL_MACHINE,"SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\{2D8ECA7B-C08C-4FA6-B9FE-30B76C03B8DC}_is1","DisplayName"));
			
			System.out.println("==> " + readString(HKEY_LOCAL_MACHINE,"SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\{2D8ECA7B-C08C-4FA6-B9FE-30B76C03B8DC}_is1","Publisher"));
			
			
			
//			System.out.println("==> " + readString(HKEY_CURRENT_USER,"Software\\WinRAR\\DialogEditHistory\\ArcName","0"));
